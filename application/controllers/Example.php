...
class Example extends MX_Controller {
    ...
    public function index() {
      ...
      //print_r($this->controllerlist->getControllers());
        ...
        //$this->aauth->logout();
        /*if ($this->aauth->login('foolsopts02@hotmail.com', '1234567')){
            echo 'PASS!';
            print_r($this->aauth->get_user());
        }else{
            echo 'NO PASS!';
    ...
    public function add_to_group()
    {
      ...
      print_r($this->aauth->infos);
    }

    public function get_group($user)
    {
      print_r($this->aauth->get_user_groups($user));
    }
    public function make_group()
    {
      $name = $this->input->get('name');
      $definition = $this->input->get('def');
      if($result = $this->aauth->create_group($name, $definition)){
        echo $result;
      }else{
        print_r($this->aauth->infos);
      }
    ...
    public function login() {
      ...
      $pass = $this->input->get('pass');
        if ($this->aauth->login($user, $pass,true)){
            echo 'PASS!';
            print_r($this->aauth->get_user());
        }else{
            echo 'NO PASS!';
    ...
    public function regis()
    {
      ...
      $pass = $this->input->get('pass');
      $name = $this->input->get('name');
      $this->aauth->create_user($user, $pass, $name);
    }
